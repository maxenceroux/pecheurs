...
/** @type {string} */
const CACHE_VERSION = '1749587287|4510423730';
/** @type {string} */
const CACHE_PREFIX = 'pacs_peche-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'pacs_peche.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["pacs_peche.html","pacs_peche.js","pacs_peche.offline.html","pacs_peche.icon.png","pacs_peche.apple-touch-icon.png","pacs_peche.audio.worklet.js","pacs_peche.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["pacs_peche.wasm","pacs_peche.pck"];
